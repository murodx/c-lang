...
int main(void)
{
    ...
    struct person people[] = { {"Tom", 23}, {"Alice", 27}, {"Bob", 31}, {"Kate", 29 }, {"Murod",19}};
...
int load(char * filename)
{
    ...
    {
        //*c = getc(fp): Считывает один байт из файла и сохраняет его по адресу,        // на который указывает c в данном случае это ptr_count
        c++;
        m--;
    }
